...
function _ref$1() {
  _ref$1 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(templates) {
    var type;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function _ref$2() {
  _ref$2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(files, verbose) {
                ...
                return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _context2.next = 2;
                        return fs.ensureDir(path.dirname(f.path));
...
function _ref$3() {
  _ref$3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(template, destination) {
    var verbose,
        defaultContext,
        setupOverride,
        logger,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            log = logger.log;
            log("\uD83E\uDDF1 PIT: Creating a new template in ".concat(chalk.bold(path.join(cwd, destination)), "."));
          ...
          case 39:
            log('');
            log("New ".concat(chalk.bold(config.name), " saved to ").concat(chalk.bold(path.join(cwd, destination)), "."), 'success');
