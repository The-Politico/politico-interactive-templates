...
function _ref$3() {
  _ref$3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(baseContext) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            log = logger.log;
            absoluteTemplateDir = path.join(cwd, templateDirectory);
